...
var getNewNumber=function(spinner){
	//alert("inside getNewNumber");
	 ...
	 var  matchType=$("#dateTypeSelction").val() ;
	// alert("date_1 ::"+date_1);
	// alert("date_1 :"+date_2);
	 
	/* if(document.getElementById('dateTypeSelction2').checked && matchId=='0' ){
	 ...
	 /*if (document.getElementById('dateTypeSelction2').checked ) {//match date
		 matchType="MDATE";
	 }else if( document.getElementById('dateTypeSelction1').checked){ //date range
		 matchType="DATER";
	 }*/
    ...
    $.ajax({
     ...
     //   "&number="+numberListByDate,
       url:"test_1.jsp?action=check&num1="+num1+"&num2="+num2+"&date_1="+date_1+"&date_2="+date_2+"&matchId="+matchId+"&matchType="+matchType,
        method:"POST",
        async:false,
               ...
               // obj = JSON.parse(response.trim());
                ...
                if(response){
                	...
                	if(num[1]=='1' && num[2]=='1' && num[3]=='1' && num[4]=='1' && num[5]=='1' && num[6]=='1'){
                		alert("No winners for your selection.");
