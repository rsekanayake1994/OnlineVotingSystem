...
var getNewNumber1=function(spinner){
	...
	// var description =$('#description1').val();
	 var winnerList=$('#winnerList').find(":selected").text();
	 var  matchType="";  
	// alert("date_1 ::"+date_1);
	 //alert("date_2 :"+date_2);
    ...
    $.ajax({
     ...
     //   "&number="+numberListByDate,
       url:"test_1.jsp?action=check1&winnerList="+winnerList,
        method:"POST",
        async:false,
